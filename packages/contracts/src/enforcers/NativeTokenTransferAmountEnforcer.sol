...
import {NativeTokenTransferAmountEnforcer as DtkNativeTokenTransferAmountEnforcer} from
    "@delegation-framework/enforcers/NativeTokenTransferAmountEnforcer.sol";
