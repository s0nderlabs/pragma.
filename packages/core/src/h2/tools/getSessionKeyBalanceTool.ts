...
export const getSessionKeyBalanceTool = tool(
  ...
  },
  {
    ...
    description: "SOURCE OF TRUTH for session key balance. You CANNOT know how much MON is in the session key without calling this tool. Never guess gas balance.",
